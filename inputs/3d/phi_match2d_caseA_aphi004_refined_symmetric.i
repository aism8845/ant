...
#   lcorr = 0.015
#
# Generate from the repo root, overriding mesh/output per mesh family:
#   ./ant-opt -i inputs/3d/phi_match2d_caseA_aphi004_refined_symmetric.i \
#     mesh_file=inputs/3d/puck_refined_symmetric_20k.msh \
#     Outputs/out/file_base=inputs/3d/phi_20k_phi008_aphi004
...
[Outputs]
  [out]
    type = Exodus
    file_base = inputs/3d/phi_20k_phi008_aphi004
