# 3D speckle field on the current puck mesh:
#   phi0 = 0.08
#   Aphi = 0.015
#   lcorr = 0.015
#
# Generate from the repo root:
#   ./ant-opt -i inputs/3d/phi_match2d_caseA_aphi0015.i \
#     mesh_file=inputs/3d/puck_refined_symmetric_20k.msh \
#     Outputs/out/file_base=outputs/3d/phi_match2d_caseA_aphi0015
...
[Outputs]
  [out]
    type = Exodus
    file_base = outputs/3d/phi_match2d_caseA_aphi0015
