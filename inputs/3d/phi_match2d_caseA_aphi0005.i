# 3D speckle field matched to the 2D setup with small amplitude:
#   phi0 = 0.08
#   Aphi = 0.005
#   lcorr = 0.015
#
# Generate from the repo root:
#   ./ant-opt -i inputs/3d/phi_match2d_caseA_aphi0005.i \
#     mesh_file=inputs/3d/puck_refined_symmetric_20k.msh \
#     Outputs/out/file_base=outputs/3d/phi_match2d_caseA_aphi0005
...
[Outputs]
  [out]
    type = Exodus
    file_base = outputs/3d/phi_match2d_caseA_aphi0005
