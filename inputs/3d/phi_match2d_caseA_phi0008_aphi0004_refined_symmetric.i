...
#   ./ant-opt -i inputs/3d/phi_match2d_caseA_phi0008_aphi0004_refined_symmetric.i \
#     mesh_file=inputs/3d/puck_refined_symmetric_20k.msh \
#     Outputs/out/file_base=inputs/3d/phi_20k_phi0008_aphi0004
...
[Outputs]
  [out]
    type = Exodus
    file_base = inputs/3d/phi_20k_phi0008_aphi0004
