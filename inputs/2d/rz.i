...
[Adaptivity]
  marker = n_front_marker
  max_h_level = ${amr_max_h_level}
  interval = ${amr_interval}
  cycles_per_step = ${amr_cycles}
  [Indicators]
    [n_front_jump]
...
[Executioner]
  ...
  petsc_options_value = 'newtonls basic 0.7 preonly lu mumps 1e-4 1e-7'
...
[Outputs]
  ...
  [exodus]
    ...
    show = 'ux uy n phi_ref_ic phi_cell_aux eta_aux kT1_aux k_diss_aux ke_aux kh_aux fa_aux gp_aux press_aux J_aux J_nutr_aux Jdot_nutr_aux n_sink_aux D_phys_aux phi_cell_nutr_aux J_mech_nutr_aux F_inv_guard_aux'
  []
  [csv]
    type = CSV
    file_base = outputs/2d/rz
